...
export default function ProductDetail_Ex02() {
  const { idProduct } = useParams();
  const product = products.filter((p) => p.id === Number(idProduct));
      ...
      <Layout style={layoutStyle}>
        ...
        <Content style={contentStyle}>
          <div style={{ padding: "20px 40px" }}>
            <h1 style={{ marginBottom: 20 }}>Chi tiết sản phẩm</h1>
            <div
              style={{
                display: "flex",
                flexWrap: "wrap",
              ...
              {product ? (
                product.map((product) => (
                  ...
                  >
                    ...
                    <a href={`/products-ex02`} style={{ color: "blue" }}>
                      Quay lại danh sản phẩm
                    </a>
                  </Card>
                ))
              ) : (
                ...
                >
                  <Link to={`/products-ex02`} style={{ color: "blue" }}>
                    Quay lại danh sản phẩm
                  </Link>
                </Card>
              )}
